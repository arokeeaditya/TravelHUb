import { SkyadventurePage } from './../skyadventure/skyadventure';
...
/**
 * Generated class for the SkyadvPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-skyadv',
  templateUrl: 'skyadv.html',
})
export class SkyadvPage {
  ...
  skyitems = [
    {
      ...
      "src": "http://skydiveperris.com/wp-content/uploads/2014/12/First-Time-Skydiving-Los-Angeles.jpg",
      "loc1": "Goa:",
      ...
      "src1": "https://www.skydivenewengland.com/wp-content/uploads/2017/03/Swoopware-0045-1200x900.jpg",
      ...
      "src2": "https://d18gmz9e98r8v5.cloudfront.net/ptr/20140226053924_50446282_2712_9.jpg",
      "loc3": " Pondicherry:",
      ...
      "src3": "https://d18gmz9e98r8v5.cloudfront.net/ptr/20140226053924_50446282_2712_9.jpg",
      "loc4": "Karnataka: ",
      ...
      "src4": "https://d18gmz9e98r8v5.cloudfront.net/ptr/20140226053924_50446282_2712_9.jpg"
    },

    {
      ...
      "src": "https://www.makemytrip.com/travel-guide/media/dg_image/jaipur/Paragliding.jpg",
      "loc1": "Baga Beach",
      ...
      "src1": "https://www.makemytrip.com/travel-guide/media/dg_image/jaipur/Paragliding.jpg",
    ...
    },
    {
      ...
      "src": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXQtUSHvO4l0ro-2C3TETo7mIOrdWCqWbTC66gAth_Y1rh_B_1",
      ...
      "src1": "https://ushotairballoon.com/wp-content/uploads/2017/04/gettysburg-lake.jpg",
    ...
    },
    {
      ...
      "src": "https://images.buyagift.co.uk/common/client/Images/Product/Extralarge/en-GB/1042525-1_extralarge.jpg",
      ...
      "src1": "https://images.buyagift.co.uk/common/client/Images/Product/Extralarge/en-GB/1048204.jpg",
    ...
    },
      {
        ...
        "src": "https://freetimemallorca.com/1271-tm_large_default/parasailing.jpg",
        ...
        "src1": "http://catalinatours.com/wp-content/uploads/2016/06/Catalina-parasailing-with-cruise-ship-1024x576.jpg",
        "loc2": "Lakshadweep",
      ...
      },
    {
      "title": "Flying Fox",
        ...
        "src": "http://img.over-blog-kiwi.com/600x600/1/72/05/18/20161006/ob_3a35b2_flying-fox-in-rishikesh.jpg",
        "loc1": " Kali River:",
        "price1": "",
        ...
        "src1": "https://cdn.shopify.com/s/files/1/1531/9251/products/35502958_l_1024x1024.jpg?v=1514467366",
        "loc2": "Goa",
        "price2": "",
    ...
    },
    {
      ...
      "price": "Rs 5,000 – 10,000",
      "description": "The deep clean water and beautiful marine life makes Andaman and Nicobar Islands one of the most fascinating destinations for scuba diving in India. These islands offer many diving sites that have a terrific variety of marine animals such as Scorpion fish, Octopus, Angler fish, Sharks and Coral reefs as well.",
      "src": "https://images.thrillophilia.com/image/upload/s--pbIeJzEQ--/c_fill,f_auto,fl_strip_profile,h_800,q_auto,w_1300/v1/images/photos/000/013/082/original/0.jpg.jpg?1458194370",
      "loc1": "Goa:",
      "price1": "Rs 5,000 – 8,000",
      "description1": "If you think Goa is all about the beaches, clubs, shacks and alcohol, think again! There are a number of diving sites present in Goa that you must visit for sure to unearth the underwater treasure of Goa. The water bodies in Goa may not be the most ideal to dive in but they are pleasant enough.",
  ...
  nav(item) {
    this.navCtrl.push(SkyadventurePage, { item:item});
  }


  // loadJson() {
  //   this.http.get(this.url='https://api.myjson.com/bins/vhg5r')
  //   .map(res => res.json())
  //   .subscribe(data => {
  //     this.data = data;
  //     console.log(data);
